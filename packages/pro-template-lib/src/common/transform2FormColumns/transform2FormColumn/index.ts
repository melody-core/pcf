 ...
 * @LastEditTime: 2023-10-15 20:03:21
 * @FilePath: /melodyLCP/packages/pro-template-lib/src/common/transform2FormColumns/transform2FormColumn/index.ts
 * @Description: update here
 */
export * from './transformCommon';
